...
import {ConsultaMoneda} from "@/app/g_ejemplo_criptomoneda/interfaces/consulta_moneda";
        ...
        <>
            <div className="text-center">
                ...
                <img className={'rounded'}
                     src="https://media.ambito.com/p/e2e0836c4f57f5ae2890d784df8de512/adjuntos/239/imagenes/038/723/0038723804/criptomonedasjpg.jpg"></img>
            </div>
            <h2>Seleccion</h2>
                ...
                <div className={"col-sm-6"}>
                    {
                        ...
                        <div>
                            ...
                            <p><strong>Precio mas bajo del dia:</strong>
                                {resultado.LOWDAY}</p>
                            <p><strong>Variacion las ultimas 24 horas:</strong>
                                {resultado.CHANGECT24HOUR}</p>
